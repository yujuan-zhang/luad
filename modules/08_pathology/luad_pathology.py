...
Two execution modes:
  ...
  Thumbnail mode (default, no GPU needed):
    Input : modules/08_pathology/data/input/thumbnails/{case_id}.png
    Steps :
  ...
  Full WSI mode (requires openslide + GPU recommended):
    Input : modules/08_pathology/data/input/svs/{case_id}.svs
    Steps :
...
Outputs (per patient):
  data/output/08_pathology/{case_id}/
...
OUT_DIR      = PROJECT_DIR / "data/output/08_pathology"
