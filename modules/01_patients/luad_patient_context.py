...
Steps:
  ...
  6. Save:
       data/output/01_patients/clinical_summary.tsv
       data/output/01_patients/{sample_id}_patient_card.png

Input:
  GDC REST API (public, no token needed)
  data/output/02_variants/{sample_id}/{sample_id}_tmb.tsv
...
OUT_DIR      = PROJECT_DIR / "data/output/01_patients"
